...
<style>
    <?php include 'CSS/internetrecht.css';
    ?>
</style>
...
<div class="terms-container">
    ...
    <p>Stand: 27. Juli 2022</p>
    <br>
    <P>Wenn Sie Ihre Einwilligung zur Datenschutzerklärung widerrufen möchten, klicken Sie bitte auf den folgenden Link:</P>
    <label><input type="checkbox" name="privacy" required>
        <a href="privacy.php" target="_blank">Datenschutzerklärung</a> Einverständnis widerrufen</label>

    <h2> Datenschutzbeauftragter:</h2>
    <p>Max Muster
        <br>Sollten Sie Fragen zum Datenschutz in Verbindung mit dieser Website haben, wenden Sie sich bitte an:

        <br>Max Muster<br/>
        Ammerländer Heerstraße 114-118<br/>
        Gebäude 44<br/>
        26129 Oldenburg
        <br>Telefon: +49 (0) 123 44 55 66<br/>
        <br>Telefax: +49 (0) 123 44 55 99<br/>
        <br>E-Mail: mustermann@kinosindeutschland.de
    </p>
    <h2>Vertretungsberechtigte Personen:</h2>
    <p>Lubaba Almohammad/p>
    ...
    <p> Arten der verarbeiteten Daten:<br>
        <ul><li>Kontaktdaten</li>
        <li>Inhaltsdaten</li>
        <li>Nutzungsdaten</li>
    <li>Meta-/Kommunikationsdaten</li></ul>
    ...
    <ul><li>Erbringung vertraglicher Leistungen und Kundenservice</li>
    ...
    <p>
        Vertragserfüllung und vorvertragliche Anfragen (Art. 6 Abs. 1 S. 1 lit. b. DSGVO):<br>
   <ul><li>Die Verarbeitung ist für die Erfüllung eines Vertrags, dessen Vertragspartei die betroffene Person ist, oder
            zur Durchführung vorvertraglicher Maßnahmen erforderlich, die auf Anfrage der betroffenen Person erfolgen.</li></ul>
    </p>

    <p>
        Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f. DSGVO):<br>
        <ul><li>Die Verarbeitung ist zur Wahrung der berechtigten Interessen des Verantwortlichen oder eines Dritten
    ...
    <p>Zusätzlich zu den Datenschutzregelungen der Datenschutz-Grundverordnung gelten nationale Regelungen zum
        ...
        Übermittlung sowie automatisierten Entscheidungsfindung im Einzelfall einschließlich Profiling. Des Weiteren
        regelt es die Datenverarbeitung für Zwecke des Beschäftigungsverhältnisses (§ 26 BDSG), insbesondere im
        Hinblick auf die Begründung, Durchführung oder Beendigung von Beschäftigungsverhältnissen sowie die
        Einwilligung von Beschäftigten. Ferner können Landesdatenschutzgesetze der einzelnen Bundesländer zur
    ...
    <p>Vorbehaltlich ausdrücklicher Einwilligung oder vertraglich oder gesetzlich erforderlicher Übermittlung
        ...
        Informationsseite der EU-Kommission:<br
    ...
    <h2>Einsatz von Session Cookies</h2>
    <p> Session Cookies sind kleine Speichervermerke, welches zwischen dem Webbrowser eines Users und
        dem Webserver ausgetauscht wird. Session Cookies können ferner zu unterschiedlichen Zwecken eingesetzt werden,
        z.B. zu Zwecken der Funktionsfähigkeit, Sicherheit und Komfort von Onlineangeboten sowie der Erstellung von
        Analysen der
        Besucherströme. </p>
    <p>Hinweise zur Einwilligung:
        Wir setzen Session Cookies im Einklang mit den gesetzlichen Vorschriften ein.</p>
    <p>Hinweise zu datenschutzrechtlichen Rechtsgrundlagen:
        Die mithilfe von Cookies verarbeiteten Daten werden auf Grundlage unserer berechtigten Interessen verarbeitet
        oder wenn dies im Rahmen der Erfüllung unserer vertraglichen Pflichten erfolgt, wenn der Einsatz von Cookies
        erforderlich ist, um
        unsere vertraglichen Verpflichtungen zu erfüllen. Zu welchen Zwecken die Cookies von uns verarbeitet werden,
        darüber klären wir im Laufe dieser Datenschutzerklärung.</p>
    <p>Speicherdauer:
    <li>Session Cookies (auch: Temporäre- oder Sitzungs-Cookies):
        Session Cookies werden spätestens gelöscht, nachdem ein Nutzer ein Online-Angebot verlassen und sein Endgerät
        (z.B. Browser
        oder mobile Applikation) geschlossen hat.
    </li>
    </ul>
    <p>Allgemeine Hinweise zum Widerruf und Widerspruch (Opt-Out):
    <li>Nutzer können einen Widerspruch gegen die Verarbeitung entsprechenden gesetzlichen Vorgaben im Art. 21 DSGVO
        einlegen.Nutzer können ihren Widerspruch auch über die Einstellungen ihres Browsers erklären, z.B. durch
        Deaktivierung der Verwendung von Cookies (wobei dadurch auch die Funktionalität unserer Online-Dienste
 ...
 <ul>  <li>Verarbeitete Datenarten: Inhaltsdaten (z.B. Eingaben in Onlineformularen);
         Meta-/Kommunikationsdaten (z.B. IP-Adressen).</li>
     <li>Betroffene Personen: Nutzer</li>
    <li>Zwecke der Verarbeitung: Bereitstellung unseres Onlineangebotes und Nutzerfreundlichkeit; Informationstechnische
        Infrastruktur (Betrieb und Bereitstellung von Informationssystemen und technischen Geräten).
        <h2>Kontakt- und Anfragenverwaltung</h2>
        <p>Bei der Kontaktaufnahme mit uns (z.B. per E-Mail, Telefon oder Telefax) sowie im
    ...
    <li>Verarbeitete Datenarten:
        Kontaktdaten (z.B. E-Mail, Telefonnummern); Inhaltsdaten (z.B.
         Eingaben in Onlineformularen); Meta-/Kommunikationsdaten (z.B. IP-Adressen).</li>
    <li>Betroffene Personen: Kommunikationspartner.</li>
    <li>Zwecke der Verarbeitung: Kundenservice; Kontaktanfragen und Kommunikation; Verwaltung und Beantwortung von
        Anfragen; Feedback (z.B. Sammeln von Feedback via Online-Formular); Bereitstellung unseres Onlineangebotes und
        Nutzerfreundlichkeit.
    </li>
    <li>Rechtsgrundlagen: Vertragserfüllung und vorvertragliche Anfragen (Art. 6 Abs. 1 S. 1
    ...
    <ul>
    <li>Kontaktformular: Wenn Nutzer über unser E-Mail oder andere Kommunikationswege mit uns in Kontakt treten,
        ...
        Geschäftsbeziehungen, soweit dies zu deren Erfüllung erforderlich ist und im Übrigen auf Grundlage unserer
        berechtigten Interessen sowie der Interessen der Kommunikationspartner an der Beantwortung der Anliegen und
        unserer gesetzlichen Aufbewahrungspflichten; Rechtsgrundlagen: Vertragserfüllung und vorvertragliche
    ...
    <ul>
        ...
        <li>Widerrufsrecht bei Einwilligungen: Sie haben das Recht, erteilte Einwilligungen
            jederzeit zu widerrufen.
        </li>
        <li>Auskunftsrecht: Sie haben das Recht, eine Bestätigung darüber zu verlangen, ob
        ...
        <li>Recht auf Berichtigung: Sie haben entsprechend den gesetzlichen Vorgaben das Recht, die
            Vervollständigung der Sie betreffenden Daten oder die Berichtigung der Sie betreffenden unrichtigen
            Daten zu verlangen.
        </li>
        <li>Recht auf Löschung und Einschränkung der Verarbeitung: Sie haben nach Maßgabe der
        ...
        <li>Recht auf Datenübertragbarkeit: Sie haben das Recht, Sie betreffende Daten, die Sie uns
        ...
        <li>Beschwerde bei Aufsichtsbehörde: Sie haben unbeschadet eines anderweitigen
  ...
  <ul>
    <li>Personenbezogene Daten: "Personenbezogene Daten“ sind alle Informationen, die sich auf
    ...
    <li>Verantwortlicher: Als "Verantwortlicher“ wird die natürliche oder juristische Person,
    ...
    <li>Verarbeitung: "Verarbeitung" ist jeder mit oder ohne Hilfe automatisierter Verfahren
